...
func (x *PersonReply) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_number_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x65, 0x22, 0x23, 0x0a, 0x0b, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x37, 0x0a, 0x06, 0x50, 0x65, 0x72, 0x73,
	0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x09, 0x53, 0x61, 0x79, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12,
	0x0e, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x0c, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x28,
...
type Person_SayPersonClient interface {
	...
	CloseAndRecv() (*PersonReply, error)
	grpc.ClientStream
}
...
func (x *personSayPersonClient) CloseAndRecv() (*PersonReply, error) {
...
type Person_SayPersonServer interface {
	SendAndClose(*PersonReply) error
...
func (x *personSayPersonServer) SendAndClose(m *PersonReply) error {
