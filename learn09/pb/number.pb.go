...
var file_number_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x37, 0x0a, 0x06,
	0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x12, 0x2d, 0x0a, 0x09, 0x53, 0x61, 0x79, 0x50, 0x65, 0x72,
	...
	0x79, 0x22, 0x00, 0x30, 0x01, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x3b, 0x70, 0x62, 0x62, 0x06,
...
type PersonClient interface {
	SayPerson(ctx context.Context, in *PersonRequest, opts ...grpc.CallOption) (Person_SayPersonClient, error)
}
...
func (c *personClient) SayPerson(ctx context.Context, in *PersonRequest, opts ...grpc.CallOption) (Person_SayPersonClient, error) {
...
type PersonServer interface {
	SayPerson(*PersonRequest, Person_SayPersonServer) error
}
...
func (*UnimplementedPersonServer) SayPerson(*PersonRequest, Person_SayPersonServer) error {
...
func _Person_SayPerson_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(PersonServer).SayPerson(m, &personSayPersonServer{stream})
}
